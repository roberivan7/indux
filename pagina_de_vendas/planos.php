...
<body>
  ...
  <div class="plans-page" id="plansPage">
    ...
    <div class="plans-grid">
      <div class="plan-card">
        ...
        <ul class="feature-list">
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
              ...
              </svg></span>Até 10 equipamentos</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>50 leituras/dia por equip.</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Alarmes básicos</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Dashboard padrão</li>
      ...
      <div class="plan-card featured">
        ...
        <ul class="feature-list">
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Até 50 equipamentos</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Leituras ilimitadas</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
          ...
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>3 usuários admin</li>
          <li class="feature-item dim"><span class="fi no"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <line x1="3" y1="3" x2="9" y2="9" />
                <line x1="9" y1="3" x2="3" y2="9" />
              </svg></span>SLA 99,9%</li>
        </ul>
      ...
      <div class="plan-card">
        ...
        <ul class="feature-list">
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Equipamentos ilimitados</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Leituras ilimitadas</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
          ...
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
              </svg></span>Usuários ilimitados</li>
          <li class="feature-item"><span class="fi yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke-width="2.5">
                <polyline points="2,6 5,9 10,3" />
    ...
    <div class="trust-bar">
      <div class="trust-item"><svg viewBox="0 0 16 16" fill="none" stroke-width="1.8">
          <path d="M8 1L10 6h5L11 9l2 5-5-3-5 3 2-5L1 6h5z" />
        </svg>7 dias grátis, sem cartão</div>
      <div class="trust-item"><svg viewBox="0 0 16 16" fill="none" stroke-width="1.8">
          <rect x="2" y="6" width="12" height="9" rx="2" />
          <path d="M5 6V4a3 3 0 0 1 6 0v2" />
        </svg>Pagamento 100% seguro</div>
      <div class="trust-item"><svg viewBox="0 0 16 16" fill="none" stroke-width="1.8">
          <path d="M8 1l1.5 3h3.5l-2.5 2 1 3L8 7.5 4.5 9l1-3L3 4h3.5z" />
        </svg>Cancele quando quiser</div>
      <div class="trust-item"><svg viewBox="0 0 16 16" fill="none" stroke-width="1.8">
          <circle cx="8" cy="8" r="7" />
          <path d="M8 4v4l3 1.5" />
        </svg>Suporte em português</div>
    </div>
  </div>
        ...
        <div class="form-section">
          <div class="form-section-title">
            <svg viewBox="0 0 16 16" fill="none" stroke-width="1.8">
              <path d="M8 1l1 2.5h3l-2.5 1.8 1 2.7L8 6.5 5.5 8l1-2.7L4 3.5h3z" />
            </svg>
            Dados pessoais
          </div>
          <div class="form-row">
